...
public class Boutiques  extends Activity{
	public static String id_bou_choisit ;
	ListView listV ;
	@Override
		  ...
		  listV =(ListView) findViewById(R.id.listView1);
	        ...
	        String result = null;
		     ...
		     HttpClient httpclient = new DefaultHttpClient();
		        HttpPost httppost = new HttpPost("http://10.0.2.2/Vente_imen/boutiques.php");
		             ...
		             for(int i=0;i<jArray.length();i++)
		             {
		              ...
		              json_data = jArray.getJSONObject(i);
						 ...
						 mapPPPP = new HashMap<String, Object>();
		                   ...
		                   mapPPPP.put("nom",json_data.getString("Nom_bou"));
		                   mapPPPP.put("idd",json_data.getString("Id_bou"));  
		    			...
		    			@SuppressWarnings("unchecked")
		             	public void onItemClick(AdapterView<?> a, View v, int position, long id) {
		    				...
		    				final HashMap<String, Object> map = (HashMap<String, Object>) listV.getItemAtPosition(position);
		    				 ...
		    				 Intent i = new Intent(Boutiques.this, Detail_Boutique.class);
		    				 startActivity(i);
		    				  id_bou_choisit = (String) map.get("idd") ; // recuperer l'id de categories choisit
