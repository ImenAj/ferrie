...
public class Categories  extends Activity{
	public static String id_categ_choisit ;
	ListView listV ;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
        ...
        String result = null;
	     ...
	     HttpClient httpclient = new DefaultHttpClient();
	        HttpPost httppost = new HttpPost("http://10.0.2.2/Vente_imen/categories.php");
	             ...
	             for(int i=0;i<jArray.length();i++)
	             {
	              ...
	              json_data = jArray.getJSONObject(i);
					 ...
					 mapPPPP = new HashMap<String, Object>();
	                   ...
	                   mapPPPP.put("nom",json_data.getString("Nom_categ"));
	                   mapPPPP.put("idd",json_data.getString("Id_categ"));  
	    			...
	    			@SuppressWarnings("unchecked")
	             	public void onItemClick(AdapterView<?> a, View v, int position, long id) {
	    				...
	    				final HashMap<String, Object> map = (HashMap<String, Object>) listV.getItemAtPosition(position);
	    				 ...
	    				 Intent i = new Intent(Categories.this, Sous_Categories.class);
	    				 startActivity(i);
	    				  id_categ_choisit = (String) map.get("idd") ; // recuperer l'id de categories choisit
